...
class Chunk(LanceModel):
    ...
    Attributes:
        ...
        doc_type: Whether this chunk came from the TRM or ESP-IDF docs. One of DOC_TYPES.
        ...
        chips: Every chip whose documentation build produced this exact chunk. Only
            populated for IDF chunks, and authoritative rather than best-effort: the
        ...
        revisions: Silicon-revision manual variants this chunk applies to. TRM only;
            empty for IDF, which has no revision axis. Espressif publishes more than
            ...
            Because it is empty for IDF, a revision filter must be scoped to
            doc_type = 'trm' rather than applied across all rows.
